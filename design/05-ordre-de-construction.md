...
| **5.5** | **Le nouveau départ** (§4.29) : ✅ un seul héros, ✅ le monde tiré (mer, relief, lacs, village posé au sort, fronts de 2 à 4) et ✅ l'écran-titre animé (§4.10) — codés le 20 septembre 2026 ; reste l'errance, le village qu'on choisit, le monde qui se fige, le **budget** cadeaux/menaces | Tomber dans un monde qui existait avant nous change-t-il le jeu ? |
