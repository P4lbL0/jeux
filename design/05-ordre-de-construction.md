...
| **5** ✅ | **Le village vivant**, en **douze** blocs (voir ci-dessous), **fini le 21 septembre 2026** | Les deux moitiés du jeu sont reliées |
...
| **6.2** | **La horde** (§4.33) : **vingt mille monstres**. Une seule silhouette d'orc — la teinte dit qui c'est, la luminosité dit la vie, le rouge dit le coup encaissé, la taille dit le rang. Les boss restent des objets et gardent tout. ⚠️ **Paliers refaits le 22 septembre 2026 au soir, après mesure** : le moteur tient déjà 1 200 orcs à 60 images/s et le mur est vers 1 600 — le plafond de 60 est un choix de lisibilité, pas une facture. D'abord **borner le rattrapage de pas** qui fait s'effondrer le jeu d'un coup à 2 000, puis **la grille spatiale et le niveau de détail temporel** (75 % du coût), puis **le rendu** (24 %) | Une marée est-elle encore le même jeu qu'une escouade ? |
| **6.5** | **Les builds** (§4.25) : tags, 36 compétences neuves, 26 fusions, synergies, compétences de village et de formation — *le socle (tags, pénétration, pioche pondérée) posé le 23 septembre 2026* | Deux parties de la même classe sont-elles enfin différentes ? |
...
| **8** ✅ | **Les ordres pour tous** (§4.4), **fini le 21 septembre 2026** : le mode commandement (Tab), la sélection mélangée au rectangle, le menu d'ordres en liste, un héros au travail, et le **chantier qui occupe un bâtisseur** (le reste du 7b) | Commander vingt personnes est-il agréable ? |
| **9** ✅ | **Le village armé** (§4.18), **fini le 21 septembre 2026** : la **cour d'entraînement** (un seul bâtiment, l'instructeur est un milicien), le métier de **milicien** qui tient les rues et ses trois paliers, les **dons** et leurs trois voies de réveil, et le passage **villageois → héros** qui garde son nom et ses traits | Une milice change-t-elle vraiment une nuit ? |
| **10** ✅ | **Le confort** (§4.10, §4.11), **fini le 21 septembre 2026** : le **rendu à la définition de l'écran** (fait la veille — canvas en pixels d'écran, plancher de 12 px, interface qui grandit avec la fenêtre), puis la **pause Échap** et son menu de cinq lignes (reprendre, volumes, touches, sauver et quitter, abandonner), et les **touches remappables** — trente-six actions dans une seule table, qui s'échangent au lieu de se disputer, et une ligne d'aide qui lit le mappage | Le jeu est-il net sur un écran à 150 % ? Et peut-on enfin poser la manette ? |
| **11** ✅ | **La mémoire du village** (§4.26), **finie le 21 septembre 2026** : les **relations** par paire (onze types, un seul par couple, qui s'usent et se disputent la place), les **souvenirs** bornés à huit, ce qu'une **mort** produit (trait, tombe, archives, legs), l'**héritage proposé** à la montée de niveau, et les **archives** du village avec leur récit assemblé — qui ne dit que ce qu'on sait | Le joueur raconte-t-il sa partie au lieu de la résumer ? |
| **12** ✅ | **La vie autonome** (§4.27), **finie le 21 septembre 2026** : la journée sans ordre (six tests, trois lieux, un rayon de flânerie), le **tour de rôle** à trois habitants par image, les **bulles** dessinées qui disent un lien ou un stress, et les **six initiatives** testées sur événement — trois annoncées par nuit au maximum | Le village a-t-il l'air habité quand on regarde ailleurs ? |
